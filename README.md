...
Откройте `standalone.html` отдельной вкладкой браузера VDI. Команды приёма и порядок совместной проверки И00–И03 приведены в инструкции. Локально прошли 3 × 1 МиБ в Full HD; реальная передача через VDI ещё не подтверждена. Возобновление живого захвата и несколько QR — И04.
