...
Статус: **И01–И03 реализованы локально; совместная проверка И00–И03 на JupyterHub/VDI впереди**. Дата: 16 сентября 2026 года.
...
И00 имеет статус **в работе** (оставшиеся замеры VDI); И01 **реализована и проверена локально** на Python 3.10/3.12; И02 **реализована и проверена локально**, приёмка в JupyterHub открыта; И03 **реализована и проверена локально** ([отчёт](docs/reports/browser-mono.md)); совместная приёмка И00–И03 на VDI отложена по договорённости до готовности И03. И04–И09 и Э01 — **запланировано**. Зависимости означают требуемые результаты, а не календарное расписание. Результаты И00: [отчёт о среде](docs/reports/environment.md), запуск: [инструкция](docs/usage/iteration-00.md).
